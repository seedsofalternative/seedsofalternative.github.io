...
In [Part I]({% post_url 2026-05-20-Part-I-finding-your-core-values %}), we explored what values actually are and why they matter. In [Part II]({% post_url 2026-05-21-Part-II-how-to-find-your-core-values %}), you worked through exercises to identify your own. Here, we tackle the harder question: once you know your values, how do you actually choose between them?
...
6. Look at your shortlist. If you were forced to **discard one forever**, which would be the _easiest_ to let go? (This helps eliminate nice-to-haves).
