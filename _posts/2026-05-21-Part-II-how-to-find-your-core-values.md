---
layout: post
title:  "Part II — How to Find your Core Values ?"
author: pierre
...
In [Part I]({% post_url 2026-05-20-Part-I-finding-your-core-values %}), we explored what core values are and why identifying them is an essential condition for a fulfilling life. In this article, we turn to the practical side: concrete exercises designed to help you uncover what you actually value — not what you think you *should* value.
...
1. List 20 things that bring you joy.
...
2. Look at your list and ask: What **values** do these things point to?
...
1. *List 10 things that frustrate you the most.*
...
2. Ask yourself: *What* ***value*** *is being violated here?*
...
![values-wheel]({{ site.baseurl }}/assets/images/values/values-wheel.png)
...
![golden_circle]({{ site.baseurl }}/assets/images/values/golden_circle.png)
...
1. Think of a time you felt deeply proud, fulfilled, or "in the zone." What were you doing? What about that experience made it so meaningful? (e.g., Were you solving a hard problem? Helping someone? Creating something? Leading a team?)
2. Think of a time you felt deeply frustrated, angry, or resentful — perhaps at work, in a relationship, or with society. What was happening? What principle was being violated? (This often points to a deeply held value: injustice violates *Fairness*; being micromanaged violates *Autonomy*.)
3. What is a character trait or principle that you must uphold to respect yourself? (e.g., "I must keep my word" points to *Integrity*. "I must stand up for the little guy" points to *Justice*.)
4. Look at the people you admire most. What values do they embody that you aspire to?
5. What is one value you hope people use to describe you when you're not in the room? (e.g., "She's so reliable" = *Dependability*. "He's genuinely kind" = *Kindness*.)
